...
public interface INotifier extends Serializable {
	...
	default void showWarningNotification(String message) {
		Notification notification = new Notification(WARNING, message, Notification.Type.WARNING_MESSAGE);
	...
	default void showErrorNotification(String message) {
		Notification notification = new Notification(ERROR, message, Notification.Type.ERROR_MESSAGE);
