...
/**
 * SecurityUtils takes care of all such static operations that have to do with security
 * and querying rights from different beans of the UI.
 *
 */
public class SecurityUtils {
	 ...
	 *
	 * @return the user name of the current user or <code>null</code> if the user has not
	 * signed in
	 */
